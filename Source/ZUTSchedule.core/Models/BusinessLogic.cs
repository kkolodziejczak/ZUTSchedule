    ...
    public class BusinessLogic
    {
        ...
        public async Task<List<DayViewModel>> GetClassesAsync()
        {
            ...
            try
            {
                ...
                var modeToSemesterViewContent = new StringContent(GenerateScheduleLinkForSemester(),
                    Encoding.UTF8,
                    "application/x-www-form-urlencoded");
        ...
        private string GenerateScheduleLinkForSemester()
        {
            ...
            // Summer Semester => starts above 20 February and ends in June
            if ((DateTime.Now.Month > 1 && DateTime.Now.Day > 20) && DateTime.Now.Month < 7)
            {
                // If summer semester then Year is the same
            ...
            // Winter semester => starts in October and 
            else
            {
                //  if January or February then Starting Year - 1
                ...
                {
                    // if before new year then End Date + 1
