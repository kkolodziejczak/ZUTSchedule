...
namespace ZUTSchedule.core
{
    ...
    public class EDziekanatService
    {
        ...
        private async Task<string> PostRequest(string url, HttpContent content, HttpClient client)
        {
            ...
            {
                // Some problem with Internet connection 
                // using emulator.
            }
